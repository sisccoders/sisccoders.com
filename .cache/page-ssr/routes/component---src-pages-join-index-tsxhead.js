exports.id = "component---src-pages-join-index-tsxhead";
exports.ids = ["component---src-pages-join-index-tsxhead"];
exports.modules = {
...
/***/ "./src/pages/join/index.tsx?export=head":
/*!**********************************************!*\
  !*** ./src/pages/join/index.tsx?export=head ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const JoinPage = ({
  ...
  var _meetings$find, _data$site, _data$site$siteMetada, _socials$find;
  const {
    meetings
  } = data.allMeeting;
  const beginner_tags = ["welcome", "intro", "setup", "beginner"];
  // Find the most recent fall semester that has a beginner tag
  const start_semester = (_meetings$find = meetings.find(meeting => {
    var _meeting$semester, _meeting$tags;
    return ((_meeting$semester = meeting.semester) === null || _meeting$semester === void 0 ? void 0 : _meeting$semester.toUpperCase().includes("FA")) && ((_meeting$tags = meeting.tags) === null || _meeting$tags === void 0 ? void 0 : _meeting$tags.some(tag => beginner_tags.includes(tag)));
  })) === null || _meetings$find === void 0 ? void 0 : _meetings$find.semester;
  // Filter meetings that match the start semester and have a beginner tag
  const filtered_meetings = meetings.filter(meeting => {
    var _meeting$semester2, _meeting$tags2;
    return ((_meeting$semester2 = meeting.semester) === null || _meeting$semester2 === void 0 ? void 0 : _meeting$semester2.toUpperCase()) === start_semester && ((_meeting$tags2 = meeting.tags) === null || _meeting$tags2 === void 0 ? void 0 : _meeting$tags2.some(tag => beginner_tags.includes(tag)));
  });
  // Reverse the order of the meetings to be in chronological order
  const get_started_meetings = filtered_meetings.reverse();
  const meeting_cards = get_started_meetings.map(meeting => (0,_components_Card__WEBPACK_IMPORTED_MODULE_3__.createCard)({
    meeting,
    timezone: meeting.timezone
  }));
  const socials = (_data$site = data.site) === null || _data$site === void 0 ? void 0 : (_data$site$siteMetada = _data$site.siteMetadata) === null || _data$site$siteMetada === void 0 ? void 0 : _data$site$siteMetada.socialLinks;
  const discord_link = (socials === null || socials === void 0 ? void 0 : (_socials$find = socials.find(social => (social === null || social === void 0 ? void 0 : social.name) === "Discord")) === null || _socials$find === void 0 ? void 0 : _socials$find.url) || "https://sigpwny.com/discord";
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "2xl:px-40"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("section", {
    id: "join-title",
    className: "grid gap-x-8 lg:grid-cols-2 py-8"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "flex flex-col flex-grow pb-4 basis-1/2"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", null, "Welcome to SIGPwny!"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
    className: "text-3xl mb-0"
  }, "Come learn cybersecurity with 2000+ students, alum, and professionals in our Discord server."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", {
    href: discord_link,
    target: "_blank",
    rel: "noopener noreferrer",
    className: "place-self-start font-bold text-xl lg:text-2xl my-3 leading-normal btn-primary"
  }, "Join Discord"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul", {
    className: "list-decimal pl-6 pt-2"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", null, "By joining, you agree to our club ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link, {
    to: "/rules/"
  }, "rules"), "."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", null, "If you are affiliated with UIUC, make sure to ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", {
    href: "https://sigpwny.com/auth",
    target: "_blank",
    rel: "noopener noreferrer"
  }, "authenticate"), " to receive the @uiuc role and access club channels."))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_4__.StaticImage, {
    ...
    placeholder: "blurred",
    __imageData: __webpack_require__(/*! ./.cache/caches/gatsby-plugin-image/846573609.json */ "./.cache/caches/gatsby-plugin-image/846573609.json")
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("section", {
    id: "join-involve",
    className: "py-8"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", null, "How to Get Involved"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "grid gap-8 lg:grid-cols-3 pt-4 text-center"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "panel"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", null, "Learn"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, "Attending our weekly meetings is the easiest way to learn security and meet others! Watch past meetings and find upcoming meetings ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link, {
    to: "/meetings/"
  }, "here"), ".")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "panel"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", null, "Compete"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, "We play in cybersecurity competitions known as CTFs (capture the flag). Collaborating as a team lets us learn from each other and have fun!")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "panel"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", null, "Research"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, "We have connections with professors and graduate students at ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", {
    href: "https://spri.engr.illinois.edu/",
    target: "_blank",
    rel: "noopener noreferrer"
  }, "SPR@I"), ". We also support individual projects run by our members."))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
    className: "pt-4"
  }, "SIGPwny is open to all - there are no member applications, mandatory meetings, or even prerequisite knowledge needed.")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("section", {
    id: "join-beginner",
    className: "py-8"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", null, "Beginner Topics"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, "Learn the fundamental skills to quickly get into hacking and more advanced topics!"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Card__WEBPACK_IMPORTED_MODULE_3__.CardRow, {
    cards: meeting_cards,
    maxFour: true
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("section", {
    id: "join-leadership",
    className: "py-8"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", null, "FAQ / Get Involved"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
    className: "mt-4 mb-0"
  }, "Interested in learning more about the club? Want to get involved? Check out our ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link, {
    to: "/faq/"
  }, "FAQ"), " or reach out to a helper on Discord!")));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (JoinPage);
const query = "1946657759";
...
/***/ "./.cache/caches/gatsby-plugin-image/846573609.json":
/*!**********************************************************!*\
  !*** ./.cache/caches/gatsby-plugin-image/846573609.json ***!
  \**********************************************************/
/***/ ((module) => {
...
"use strict";
module.exports = JSON.parse('{"layout":"constrained","placeholder":{"fallback":"data:image/jpeg;base64,"},"images":{"fallback":{"src":"/static/27b4534d05bde310963d208ea63d7fb4/7acca/2023-09-07-web-hacking-i.jpg","srcSet":"/static/27b4534d05bde310963d208ea63d7fb4/4a9d8/2023-09-07-web-hacking-i.jpg 360w,\\n/static/27b4534d05bde310963d208ea63d7fb4/b19bf/2023-09-07-web-hacking-i.jpg 480w,\\n/static/27b4534d05bde310963d208ea63d7fb4/5d504/2023-09-07-web-hacking-i.jpg 720w,\\n/static/27b4534d05bde310963d208ea63d7fb4/bc134/2023-09-07-web-hacking-i.jpg 1280w,\\n/static/27b4534d05bde310963d208ea63d7fb4/8cf01/2023-09-07-web-hacking-i.jpg 1920w,\\n/static/27b4534d05bde310963d208ea63d7fb4/7acca/2023-09-07-web-hacking-i.jpg 4032w","sizes":"(min-width: 4032px) 4032px, 100vw"},"sources":[{"srcSet":"/static/27b4534d05bde310963d208ea63d7fb4/c27d8/2023-09-07-web-hacking-i.webp 360w,\\n/static/27b4534d05bde310963d208ea63d7fb4/0df1a/2023-09-07-web-hacking-i.webp 480w,\\n/static/27b4534d05bde310963d208ea63d7fb4/ddf6e/2023-09-07-web-hacking-i.webp 720w,\\n/static/27b4534d05bde310963d208ea63d7fb4/c2dd8/2023-09-07-web-hacking-i.webp 1280w,\\n/static/27b4534d05bde310963d208ea63d7fb4/702da/2023-09-07-web-hacking-i.webp 1920w,\\n/static/27b4534d05bde310963d208ea63d7fb4/a9256/2023-09-07-web-hacking-i.webp 4032w","type":"image/webp","sizes":"(min-width: 4032px) 4032px, 100vw"}]},"width":4032,"height":2268}');
...
;
//# sourceMappingURL=component---src-pages-join-index-tsxhead.js.map