exports.id = "component---src-pages-sponsors-tsxhead";
exports.ids = ["component---src-pages-sponsors-tsxhead"];
exports.modules = {
...
/***/ "./src/pages/sponsors.tsx?export=head":
/*!********************************************!*\
  !*** ./src/pages/sponsors.tsx?export=head ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const SponsorsPage = ({
  ...
  const min_date = dayjs__WEBPACK_IMPORTED_MODULE_1___default()().subtract(1, "year");
  const uniq_series = new Set();
  const recent_events = events.filter(event => {
    if (dayjs__WEBPACK_IMPORTED_MODULE_1___default()(event.time_start) < min_date || uniq_series.has(event.series) || !event.sponsors_profiles || event.sponsors_profiles.length === 0) return false;
    uniq_series.add(event.series);
    return true;
  });
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "flex flex-col gap-8 mx-auto page-width-lg"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", null, "Sponsors"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, "Thank you to our sponsors for supporting SIGPwny!"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "flex flex-col gap-4"
  }, featured_orgs.length > 0 ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", null, "Workshop Sponsors"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "grid gap-4 grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5"
  }, featured_orgs.map((sponsor, sponsor_idx) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    key: sponsor_idx,
    className: "flex grow"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Card__WEBPACK_IMPORTED_MODULE_3__.Card, (0,_components_Card__WEBPACK_IMPORTED_MODULE_3__.createCard)({
    sponsor
  })))))) : null, recent_events.map((event, event_idx) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    key: event_idx
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", null, event.title), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "grid gap-4 grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5"
  }, event.sponsors_profiles.map((sponsor, sponsor_idx) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    key: sponsor_idx,
    className: "flex grow"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Card__WEBPACK_IMPORTED_MODULE_3__.Card, (0,_components_Card__WEBPACK_IMPORTED_MODULE_3__.createCard)({
    sponsor
    ...
    className: "panel"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", null, "Interested in sponsoring?"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, "Please contact us at ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", {
    href: "mailto:sponsors@sigpwny.com"
  }, "sponsors@sigpwny.com"), "! Sponsors can receive a variety of benefits, from resume books to recruiting events. We are happy to work with you!")));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (SponsorsPage);
const query = "2772102715";
...
;
//# sourceMappingURL=component---src-pages-sponsors-tsxhead.js.map