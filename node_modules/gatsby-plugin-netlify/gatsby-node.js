...
exports.onPostBuild = exports.onCreateWebpackConfig = exports.pluginOptionsSchema = void 0;
...
const onPostBuild = async ({ store, pathPrefix, reporter }, userPluginOptions) => {
    ...
    const skipFilePath = (0, path_1.join)(program.directory, `.cache`, `.nf-skip-gatsby-functions`);
    const generateSkipFile = Object.values(neededFunctions).includes(false)
        ? (0, fs_extra_1.writeJson)(skipFilePath, neededFunctions)
        : (0, fs_extra_1.remove)(skipFilePath);
    await Promise.all([
        generateSkipFile,
