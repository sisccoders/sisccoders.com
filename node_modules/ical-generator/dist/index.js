...
`),this.data.events.forEach(i=>t+=i.toString()),t+=D(this.data),t+="END:VCALENDAR",O(t)}};function X(n){return new E(n)}var vt=X;export{I as ICalAlarm,L as ICalAlarmType,C as ICalAttendee,w as ICalAttendeeRole,M as ICalAttendeeStatus,V as ICalAttendeeType,E as ICalCalendar,F as ICalCalendarMethod,p as ICalCategory,y as ICalEvent,U as ICalEventBusyStatus,B as ICalEventClass,N as ICalEventRepeatingFreq,z as ICalEventStatus,P as ICalEventTransparency,S as ICalWeekday,vt as default,l as escape,O as foldLines,o as formatDate,b as formatDateTZ};
